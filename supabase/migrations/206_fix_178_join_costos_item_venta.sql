-- ╔════════════════════════════════════════════════════════════════════╗
-- ║  Migration 206 · Fix de la 178: faltaba el join a costos_item_venta ║
-- ║                                                                     ║
-- ║  La 178 tal como quedó en el repo usa el alias `civ` en             ║
-- ║  fn_resumen_skus sin haberlo unido nunca a costos_item_venta        ║
-- ║  (mig 171) → "missing FROM-clause entry for table civ". Es el       ║
-- ║  mismo join que sí tienen las migs 173, 174, 179 y 194.             ║
-- ║                                                                     ║
-- ║  Contenido: la 178 ÍNTEGRA con esa única línea agregada. Reemplaza  ║
-- ║  a la 178 en cualquier base donde ésta haya fallado; donde la 178   ║
-- ║  ya está aplicada, la deja idéntica (drop + create de las mismas    ║
-- ║  dos funciones).                                                    ║
-- ║                                                                     ║
