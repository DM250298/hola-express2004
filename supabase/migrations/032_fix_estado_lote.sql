-- ╔════════════════════════════════════════════════════════════════════╗
-- ║  Migration 032 · FIX — fn_crear_venta: cast del estado de lote      ║
-- ║                                                                     ║
-- ║  Al vender un producto con lotes, la función actualiza el estado    ║
-- ║  del lote con un CASE que devuelve `text`. La columna lotes.estado  ║
-- ║  es del tipo enum `estado_lote`, y Postgres no convierte el CASE    ║
-- ║  de forma implícita → "column estado is of type estado_lote but     ║
-- ║  expression is of type text".                                       ║
-- ║                                                                     ║
-- ║  Se reescribe fn_crear_venta agregando el cast `::estado_lote`.     ║
-- ║                                                                     ║
