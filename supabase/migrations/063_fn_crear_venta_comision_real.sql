-- ╔════════════════════════════════════════════════════════════════════╗
-- ║  Migration 063: fn_crear_venta usa comisión + IIBB REALES de MP     ║
-- ║                                                                     ║
-- ║  Cada pago puede traer `comision_monto` y/o `iibb_monto` en pesos   ║
-- ║  (los que realmente cobró Mercado Pago, leídos de /v1/payments al   ║
-- ║  aprobar el cobro con terminal). Si vienen, se usan EXACTOS en vez  ║
-- ║  de calcularlos con el % de la tabla de medios de pago / cuenta.    ║
-- ║  Si no vienen (efectivo, offline, MP no devolvió detalle), cae a    ║
-- ║  la estimación de la tabla, como antes.                             ║
-- ║                                                                     ║
-- ║  Base: v7 de la 062 (cantidad/stock numeric + IIBB). Firma idéntica ║
-- ║  → CREATE OR REPLACE reemplaza limpio.                              ║
-- ╚════════════════════════════════════════════════════════════════════╝
