-- ╔════════════════════════════════════════════════════════════════════╗
-- ║  Migration 182 · Tablero del dueño (4/4): fn_tablero_gerencial      ║
-- ║                                                                     ║
-- ║  Todo el tablero en UN viaje a la base, como jsonb:                 ║
-- ║   · ventas: hoy / ayer / 7 días / mes, cada una con su comparación, ║
-- ║     y el período elegido contra el anterior de igual largo.         ║
-- ║   · margen comercial del período y del anterior.                    ║
-- ║   · serie diaria (ventas, ingresos, margen) para el gráfico.        ║
-- ║   · quiebres: activos ahora, críticos, horas y venta perdida        ║
-- ║     ESTIMADA recortada al período.                                  ║
-- ║   · cobertura del mapeo, lotes por vencer, frescura del snapshot.   ║
-- ║   · + el bloque por producto de fn_tablero_skus (mig 181).          ║
-- ║                                                                     ║
-- ║  Gates: exige permiso 'tablero'; sin 'costos', todo lo que es costo ║
-- ║  o margen vuelve NULL (nunca 0).                                    ║
-- ║                                                                     ║
-- ║  REQUIERE: migs 172, 173, 179, 181. Ejecutar UNA sola vez, COMPLETO.║
-- ╚════════════════════════════════════════════════════════════════════╝
