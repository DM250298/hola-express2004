-- ╔════════════════════════════════════════════════════════════════════╗
-- ║  Migration 067: fn_crear_venta respeta productos.controlar_stock    ║
-- ║                                                                     ║
-- ║  Si un producto tiene controlar_stock = false, la venta NO descuenta ║
-- ║  stock, NO registra movimiento de stock, NO toca lotes y NO computa  ║
-- ║  CMV (queda fuera del circuito de inventario: servicios, granel sin  ║
-- ║  control, etc.). El item igual se registra y se cobra normal.        ║
-- ║  Con controlar_stock = true (default) se comporta igual que antes.   ║
-- ║                                                                     ║
-- ║  Base: v8 de la 063 (comisión/IIBB reales). Firma IDÉNTICA →         ║
-- ║  CREATE OR REPLACE reemplaza limpio. Único cambio: el loop de items. ║
-- ╚════════════════════════════════════════════════════════════════════╝
