...
export const PERMISOS: PermisoDef[] = [
  ...
  { clave: 'devoluciones', etiqueta: 'Hacer devoluciones', grupo: 'Ventas' },
  { clave: 'clientes', etiqueta: 'Clientes (CRM)', grupo: 'Ventas' },
  { clave: 'cuenta_corriente', etiqueta: 'Fiado: cuentas corrientes y cobranza', grupo: 'Ventas' },
  { clave: 'inventario', etiqueta: 'Ver inventario', grupo: 'Stock' },
  { clave: 'costos', etiqueta: 'Ver precios de costo', grupo: 'Stock' },
  ...
  { clave: 'conteo_cierre', etiqueta: 'Conteo físico: revisar diferencias y ajustar stock', grupo: 'Stock' },
  ...
  { clave: 'produccion', etiqueta: 'Producción / Elaboración', grupo: 'Stock' },
  ...
  { clave: 'alertas', etiqueta: 'Alertas: ver y decidir (crear tarea, posponer)', grupo: 'Análisis' },
...
export const PERMISOS_POR_ROL_LEGACY: Record<string, string[]> = {
  ...
  // produccion, costos). Mantener sincronizado con la migración 096.
  cajero: [
    'dashboard',
    'proyectos',
    'pos',
